  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        ...
        role="img"
        aria-label="Oppam Mobile Hero Background"
      />
      {/* Desktop View */}
      <div
        ...
        role="img"
        aria-label="Oppam Desktop Hero Background"
      />
      {/* The Wash: Dark Overlay */}
      <div className="fixed inset-0 z-10 bg-black/50 backdrop-blur-[2px]" />

      <div id="hero" className="relative z-20 max-w-7xl mx-auto px-6 md:px-8 py-12 pb-24">
